...
exports.confirmationEmailTemplate = confirmationEmailTemplate;
exports.adminReplyTemplate = adminReplyTemplate;
exports.invoiceEmailTemplate = invoiceEmailTemplate;
/**
 * Email template for quote confirmation sent to customers
 */
function confirmationEmailTemplate(data) {
 ...
 */
function adminReplyTemplate(data) {
